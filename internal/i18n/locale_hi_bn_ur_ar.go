...
`,
		...
		"install.installed": "स्थापित: %s\n", "install.new_version": "नया संस्करण: %s\n", "install.old_version": "पुराना संस्करण: %s\n",
...
`,
		...
		"settings.saved": "\nसहेजा: %s\n",
		"settings.prompt.table": "रूटिंग टेबल / fwmark",
...
`,
		...
		"state.state_file_err": "state फ़ाइल: %w", "state.up_line": "up: %s (config %s)\n",
...
`,
		...
		"install.installed": "ইনস্টল: %s\n", "install.new_version": "নতুন সংস্করণ: %s\n", "install.old_version": "পুরনো সংস্করণ: %s\n",
...
`,
		...
		"settings.saved": "\nসংরক্ষিত: %s\n",
		"settings.prompt.table": "রাউটিং টেবিল / fwmark",
...
`,
		...
		"state.state_file_err": "state: %w", "state.up_line": "up: %s (config %s)\n",
		"state.summary_base": "mode=%s table=%s fwmark=%s dev %s",
		"state.summary_nomark": " no_bypass_mark=1", "state.summary_bypass": " bypass_cgroup=1",
...
`,
		...
		"install.installed": "انسٹال: %s\n", "install.new_version": "نیا ورژن: %s\n", "install.old_version": "پرانا ورژن: %s\n",
...
`,
		...
		"settings.saved": "\nمحفوظ: %s\n",
		"settings.prompt.table": "روٹنگ ٹیبل / fwmark",
...
`,
		...
		"install.installed": "تم التثبيت: %s\n", "install.new_version": "الإصدار الجديد: %s\n", "install.old_version": "الإصدار السابق: %s\n",
...
`,
		...
		"settings.saved": "\nحُفظ: %s\n",
		"settings.prompt.table": "جدول التوجيه / fwmark",
		"settings.prompt.systemd_network": "systemd-networkd", "settings.prompt.lan_cidr": "UFW LAN CIDR",
