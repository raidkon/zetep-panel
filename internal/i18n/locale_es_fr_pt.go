...
`,
		...
		"install.installed": "instalado: %s\n", "install.warn_completion": "aviso: bash completion: %v\n",
...
`,
		...
		"settings.saved": "\nguardado: %s\n",
		"settings.prompt.table": "Tabla de enrutamiento / fwmark", "settings.prompt.state_dir": "Directorio state (JSON)",
...
`,
		...
		"state.state_file_err": "archivo state: %w", "state.up_line": "up: %s (state %s)\n",
...
`,
		...
		"install.installed": "installé : %s\n", "install.warn_completion": "avertissement bash completion : %v\n",
...
`,
		...
		"settings.saved": "\nenregistré : %s\n",
		"settings.prompt.table": "Table / fwmark", "settings.prompt.state_dir": "Répertoire state (JSON)",
...
`,
		...
		"state.state_file_err": "fichier state : %w", "state.up_line": "up : %s (state %s)\n",
...
`,
		...
		"settings.saved": "\nsalvo: %s\n",
		"settings.prompt.table": "Tabela / fwmark", "settings.prompt.state_dir": "Diretório state (JSON)",
...
`,
		...
		"state.state_file_err": "arquivo state: %w", "state.up_line": "up: %s (state %s)\n",
		"state.summary_base": "mode=%s table=%s fwmark=%s dev %s",
		"state.summary_nomark": " no_bypass_mark=1", "state.summary_bypass": " bypass_cgroup=1",
		"bashcomp.line1": "# bash completion z-panel", "bashcomp.line2": "# z-panel install-shell",
		"bashcomp.line3": "# Bash 4+",
